...
public static class QueryMaker
{
    ...
    {
        code = "";
        AddLine("USE " + SqlConnect.DbName +"\n");
        List<Relation> relations = new List<Relation>();
        List<Atribute> multis = new List<Atribute>();
        SqlConnect.fIndex = 0;
        foreach (var i in SqlConnect.entities)
        {
            ...
            if (many1 == many2)
            {
                ...
                foreach (var j in l)
                {
                    if (j.shape1 is Entity)
                    {
                        ...
                        foriegn += "ALTER TABLE " + i.GetName() + " ADD CONSTRAINT FK_" + j.shape1.GetName() + SqlConnect.fIndex++ + " FOREIGN KEY(" + j.shape1.GetName() + "Id) REFERENCES " + j.shape1.GetName() + "(";
                    ...
                    else
                    {
                        ...
                        foriegn += "ALTER TABLE " + i.GetName() + " ADD CONSTRAINT FK_" + j.shape2.GetName() + SqlConnect.fIndex++ + " FOREIGN KEY(" + j.shape2.GetName() + "Id) REFERENCES " + j.shape2.GetName() + "(";
        ...
        foreach (var i in multis)
        {
            ...
            if (l[0].shape1 is Entity)
            {
                ...
                foriegn += "ALTER TABLE " + i.GetName() + " ADD CONSTRAINT FK_" + l[0].shape1.GetName() + SqlConnect.fIndex++ + " FOREIGN KEY(" + l[0].shape1.GetName() + "Id) REFERENCES " + l[0].shape1.GetName() + "(";
                foreach (var k in ((Entity)l[0].shape1).atributes)
                {
                    if (k.primaryKey)
                    {
            ...
            else
            {
                ...
                foriegn += "ALTER TABLE " + i.GetName() + " ADD CONSTRAINT FK_" + l[0].shape2.GetName() + SqlConnect.fIndex++ + " FOREIGN KEY(" + l[0].shape2.GetName() + "Id) REFERENCES " + l[0].shape2.GetName() + "(";
        ...
        File.WriteAllText(Path + @"\\" + SqlConnect.DbName + "Query.sql", code);
    }
